...
public class QuizController {
    private static final String filePath = "/Users/a.ramzi_444/IdeaProjects/QuizLogin/src/main/java/com/example/quiz/progress.txt";
    ...
    private void end() throws IOException {
        ...
        String progress = String.format("Correct: %d\nWrong: %d", correct, wrong);
    ...
    private void saveProgressToFile(String progress) throws IOException {
